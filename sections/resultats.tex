...
\begin{table}[h]
    ...
    \end{tabular}
    \caption{Tableau d'exploitation des mesures de la méthode des points conjugués avec un objet réel. 
    Les incertitudes sont calculées à partir de la méthode de la différentielle totale.}
\end{table}
